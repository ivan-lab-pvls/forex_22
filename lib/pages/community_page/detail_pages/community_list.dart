...
class CommunityList {
  static const List<CommunityView> stats = [
    CommunityView(
      title: "Cryptocurrency, Explained: A Guide for Beginners",
      description:
